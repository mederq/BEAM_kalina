...
# player image na razie nie działa:(
...
while run:
    ...
    if keys[pygame.K_LEFT] and playerX > player_velocity + 10:
    ...
    player = pygame.draw.rect(screen, (255, 0, 0), (playerX, playerY, player_width, player_height))
